...
# First import data
# Data in excel file
# 'readxl' package required to read excel/csv file

# Check list of library ensure the required package there
.libPaths() # Gives path to the library

getwd() # Gives current working directory

## If the package 'realxl' not in the list of libraries in library folder
# Install package
